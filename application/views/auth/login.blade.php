...
<div class="login login-1 login-signin-on d-flex flex-column flex-lg-row flex-column-fluid bg-white" id="kt_login">
	<!--begin::Aside-->
	<div class="login-aside d-flex flex-row-auto bgi-size-cover bgi-no-repeat p-10 p-lg-10" style="background-image: url(<?php echo THEME_URL . 'assets/media/bg/bg-2.jpg' ?>);">
		<!--begin: Aside Container-->
		<div class="d-flex flex-row-fluid flex-column justify-content-between">
			<!--begin: Aside header-->
			<a href="#" class="flex-column-auto mt-5 pb-lg-0 pb-10">
				<img src="<?php echo THEME_URL . 'assets/media/logos/logo-letter-1.png'; ?>" class="max-h-250px" alt="eRegistro 2024" />
			</a>
			<!--end: Aside header-->
			<!--begin: Aside content-->
			<div class="flex-column-fluid d-flex flex-column justify-content-center">
				<h3 class="font-size-h1 mb-5 text-white">Bienvenidos!</h3>
				<p class="font-weight-lighter text-white opacity-80">En esta app podrás captar los simpatizantes de tu candidato</p>
			</div>
			<!--end: Aside content-->
			...
			<div class="d-none flex-column-auto d-lg-flex justify-content-between mt-10">
				...
				<div class="d-flex">
					...
					<a href="https://wa.me/3125500636" target="_blank" class="text-white ml-10">Contacto</a>
				</div>
			</div>
	...
	<div class="d-flex flex-column flex-row-fluid position-relative p-7 overflow-hidden">
		...
		<div class="d-flex flex-column-fluid flex-center mt-30 mt-lg-0">
			...
			<div class="login-form login-signin">
				...
				<div class="text-center mb-10 mb-lg-20">
					...
					<p class="text-muted font-weight-bold">Introduce tu usuario y contraseña</p>
				</div>
				<!--begin::Form-->
				<form class="form" novalidate="novalidate" id="kt_login_signin_form">
					...
					<div class="form-group d-flex flex-wrap justify-content-between align-items-center">
						...
						<button type="button" id="kt_login_signin_submit" class="btn btn-dark font-weight-bold px-9 py-4 my-3">Entrar</button>
					</div>
					<!--end::Action-->
				</form>
				<!--end::Form-->
			...
			<div class="login-form login-signup">
				...
				<form class="form" novalidate="novalidate" id="kt_login_signup_form">
					...
					<div class="form-group">
						<input class="form-control form-control-solid h-auto py-5 px-6" maxlength="10" type="text" placeholder="Telefono" name="identity" autocomplete="off" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" />
					</div>
					<!-- <div class="form-group">
		...
		<div class="d-flex d-lg-none flex-column-auto flex-column flex-sm-row justify-content-between align-items-center mt-5 p-5">
			...
			<div class="d-flex order-1 order-sm-2 my-2">
				...
				<a href="https://wa.me/3125500636" target="_blank" class="text-dark-75 text-hover-primary ml-4">Contacto</a>
			</div>
		</div>
